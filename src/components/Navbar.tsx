      ...
      >
        <div className="container-fluid flex items-center justify-between mx-auto max-w-screen-2xl">
          ...
          <div className="flex items-center gap-6">
            ...
            >
              <div className={`w-6 h-0.5 bg-foreground transition-all duration-300 origin-center ${isOpen ? "rotate-45 translate-y-[4px]" : "group-hover:w-4"}`} />
              <div className={`w-6 h-0.5 bg-foreground transition-all duration-300 ${isOpen ? "opacity-0 scale-0" : ""}`} />
              <div className={`w-6 h-0.5 bg-foreground transition-all duration-300 origin-center ${isOpen ? "-rotate-45 -translate-y-[4px]" : "group-hover:w-4 self-end"}`} />
            </button>
          </div>
        </div>
      </nav>
