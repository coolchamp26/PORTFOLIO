...
const educationData: EducationItem[] = [
    ...
    },
    {
        ...
        degree: "Class 12th (Stream: PCM with CS)",
        score: "95.6%",
        icon: "school",
    },
    {
...
const Education = () => {
    return (
        <section id="education" className="py-16 md:py-32 px-6 md:px-12 bg-foreground text-background">
            <div className="container-fluid max-w-screen-2xl mx-auto">
                <div className="mb-16 border-t-8 border-background pt-8">
                    <h2 className="text-large text-background">Academic <br /> Archive</h2>
                </div>
                    ...
                    {educationData.map((item) => (
                        ...
                        >
                            ...
                            <div className="md:col-span-6">
                                <h3 className="text-4xl md:text-5xl font-black mb-4 leading-[0.9] tracking-tighter">
                                    {item.institution}
                                </h3>
                            ...
                            <div className="md:col-span-4 flex flex-col items-start md:items-end justify-center">
                                ...
                                <p className="text-7xl md:text-8xl font-black tracking-[-0.08em] leading-none">
